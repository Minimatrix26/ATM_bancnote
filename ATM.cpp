...
void ATM::afisareColectie() {
    colectie.saveToFile("E:\\info CLion\\lab_4-5_SD_v1 - Copie\\colectie.txt");
...
void ATM::plateste() {
    ...
    if(suma < sumaCareTrebuiePlatita || suma > sumaCareTrebuiePlatita)
        ...
        if(decizie == "da")
        {
            ...
            tranzactie.saveTransactionToFile("E:\\info CLion\\lab_4-5_SD_v1 - Copie - Copie\\tranzactii.txt");
            colectie.setNewOccs(occur_bancnote);
            //colectie.setNewOccs_2(occur_bancnote);
            colectie.saveToFile("E:\\info CLion\\lab_4-5_SD_v1 - Copie - Copie\\colectie.txt");
            cout << tranzactie;
        }
        else if(decizie == "nu")
            cout << "OK..." << endl;
